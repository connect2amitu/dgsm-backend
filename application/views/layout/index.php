    ...
    <div class="navbar navbar-inverse header-highlight">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <div class="navbar-right">
                <p class="navbar-text">Morning, Amit!</p>
                        ...
                        <div class="category-content no-padding">
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li class="<?= $this->uri->segment(1)==="tracks"?"active":""?>"><a
                                        href="<?=base_url('/tracks')?>"><i class="icon-width"></i> <span>Track</span></a>
                                </li>
                                <!-- <li><a href="<?=base_url('/bhajan')?>"><i class="icon-width"></i> <span>Audio</span></a></li> -->
                                <!-- <li>
