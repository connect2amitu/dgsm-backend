    ...
    <div class="page-header-content">
        <div class="page-title">
            <h5>
                ...
                <span class="text-semibold">Artist</span>
...
<div class="content">
    <div class="row">
        <div class="page-header-content">
            ...
            <a href="<?= base_url('artists/add'); ?>" class="btn btn-rounded mb-20 btn-success legitRipple">Add <i
                    class="icon-add-to-list"></i> </a>
        </div>
    </div>
    <div class="row">
        <div class="panel panel-flat">
        <form id="checkboxdata" method="POST" action="<?= base_url('artists/deleteall'); ?>">
  ...
  $('#dTable').DataTable({
    ...
    'columns': [
        ...
        { data: 'name',targets:2},
        {
          ...
          orderable: false, 
          "render": function ( data, type, row, meta ) {
            var path = "<?= base_url('artists/edit/');?>"+row.id
            return `
