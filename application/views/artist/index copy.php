...
<div class="content">
	<div class="row">
		<div class="page-header-content">
				...
				<a href="<?= base_url('artist/add'); ?>" class="btn btn-rounded mb-20 btn-success legitRipple">Add <i
				class="icon-add-to-list"></i> </a>
	</div>
	</div>
	<div class="row">
		<div class="panel panel-flat">
			<form id="checkboxdata" method="POST" action="<?= base_url('artist/deleteall'); ?>">
						...
						<?php
							...
							<tr>
								...
								<td style="display:flex">
									<a style="margin-right:5px;color:green" href="<?= base_url('artist/edit/'.$row['id']); ?>"
